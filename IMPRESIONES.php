	...
	function ventas($archivo,$ciudad,$venta,$detalle,$impresora,$empresa,$guia="")
	{
		...
		if($archivo == "facturacionticketeramce76x189.php")
		{
			...
			for($j=0; $j < 1; $j++)
			{
				...
				printer_draw_text($handle, '_____________________________________________________________', 0,$linea);
				$linea+=25;
				printer_draw_text($handle, "       CLAUSULA DE PROTECCION DE DATOS PERSONALES", 0,$linea);
				$linea+=25;
				printer_draw_text($handle, "En cumplimiento de la Ley Organica de Proteccion de", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "Datos Personales, informamos que los datos personales", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "consignados en esta factura seran tratados por", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "MUMUSO ECUADOR, como Responsable del Tratamiento,", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "para gestionar la relacion comercial y cumplir", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "obligaciones legales, tributarias y contables.", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "Sus datos podran ser comunicados a autoridades", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "competentes y encargados del tratamiento.", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "Puede ejercer sus derechos de acceso, rectificacion,", 0,$linea);
				$linea+=20;
				printer_draw_text($handle, "actualizacion, eliminacion, oposicion, portabilidad y", 0,$linea);
				$linea+=20;
